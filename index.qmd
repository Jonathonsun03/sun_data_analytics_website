...
Sun Data Analytics, LLC is an independent analytics studio and public portfolio for practical data projects. I build reports, dashboards, tools, and workflows that make messy information easier to understand and use.
...
<section class="front-page-work" aria-label="Featured work">
  ...
  <div class="side-work-list">
    <a class="content-card compact-work-card" href="pages/portfolio/data-collection.html">
...
If you need a cleaner report, a dashboard people can actually use, a repeatable data workflow, or help turning research material into findings, contact [jonathon@sun-dataanalytics.com](mailto:jonathon@sun-dataanalytics.com).